...
setwd("/Users/swade/Documents/Learning/Online/Coursera/Data Science Foundations using R/5 Reproducible Research/Week2Project")

```

```{r global_options, include=FALSE, echo = TRUE}
df <- read.csv("activity.csv", header=TRUE)
knitr::opts_chunk$set(fig.width=10, fig.height=6, fig.path='figure/',
...
```{r histogram, cache = FALSE, echo=TRUE}
